      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-8 sm:px-16 md:px-24 relative z-10">
        ...
        >
          <motion.div variants={fadeUpVariant} className="mb-10 text-center lg:text-left">
            ...
            <p className="text-sm text-slate-500 font-light">Enter your credentials to access the engine.</p>
          </motion.div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <motion.button 
              ...
              type="submit"
              className="w-full py-3 bg-slate-900 text-white font-semibold rounded-xl hover:bg-slate-800 transition-all shadow-md hover:-translate-y-0.5 mt-2"
            >
              Sign in
            </motion.button>
          </form>
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg px-12">
          ...
          <p className="text-lg text-slate-400 font-light leading-relaxed mb-10">
            Your machine learning models have been continuously analyzing user behavior. Log in to review the latest flight risk alerts and deploy automated interventions.
          </p>

          <div className="flex items-center gap-4">
            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-slate-700 bg-slate-800 shadow-inner">
               {/* Pulsing Status Dot */}
